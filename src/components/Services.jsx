            ...
            <div className="max-w-4xl mx-auto px-6 lg:px-12">
                                        ...
                                        <div key={j} className="flex flex-col sm:flex-row sm:items-center justify-between py-5 border-b border-ink/5 last:border-0 group">
                                            ...
                                            <div className="flex items-center justify-between sm:justify-end gap-6 mt-4 sm:mt-0">
                                                ...
                                                <a
                                                    ...
                                                    className="bg-oak text-ink font-heading font-bold text-[11px] uppercase tracking-widest px-5 py-2.5 rounded-full transition-all duration-200 shadow-sm hover:bg-oak-dark hover:scale-105"
                                                >
                                                    Boka
                                                </a>
                                            </div>
                ...
                <div className="mt-16 text-center">
                    <p className="font-body text-ink/60 text-sm mb-8 italic font-medium">
                        * Priserna kan variera beroende på tidsåtgång och materialåtgång.
                    </p>
                    <a
                        href="https://www.bokadirekt.se/places/williams-harstudio-20126"
                        target="_blank"
                        rel="noopener noreferrer"
                        className="inline-flex items-center gap-3 bg-ink text-white font-heading font-bold text-sm px-10 py-5 rounded-full hover:bg-ink/90 transition-all duration-300 hover:scale-105 shadow-xl"
                    >
                        Se komplett meny på Bokadirekt
