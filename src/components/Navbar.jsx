        ...
        >
            <div className="max-w-7xl mx-auto px-6 lg:px-12 h-16 flex items-center justify-between">
                ...
                <a href="#" className="flex flex-col leading-tight group">
                    ...
                    <span
                        className={`font-mono text-[10px] tracking-widest uppercase transition-colors duration-300 ${scrolled ? 'text-oak' : 'text-oak'
                            }`}
                    >
                ...
                <div className="flex items-center gap-4">
                    <a
                        ...
                        id="navbar-boka-btn"
                        className="hidden sm:inline-flex items-center gap-2 bg-oak hover:bg-oak-dark text-white font-heading font-semibold text-sm px-5 py-2.5 rounded-full transition-all duration-200 hover:scale-105 hover:shadow-lg hover:shadow-oak/30"
                    >
                        Boka Tid
            ...
            <div
                className={`md:hidden overflow-hidden transition-all duration-300 bg-paper border-t border-ink/5 ${menuOpen ? 'max-h-96 opacity-100' : 'max-h-0 opacity-0'
                    }`}
            >
                <div className="px-6 py-4 flex flex-col gap-4">
                    ...
                    <a
                        ...
                        target="_blank"
                        rel="noopener noreferrer"
                        className="w-full text-center bg-oak text-white font-heading font-semibold text-sm px-5 py-3 rounded-full mt-2"
                    >
                        Boka Tid
                    </a>
                </div>
